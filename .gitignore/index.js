...
bot.on('message' , async msg =>{
    ...
    if(msg.content.startsWith(prefix + "nouveautés")){
        ...
        .addField("Malheureusement, il n'y aura pas de nouvelles misa à jours pendant 15 jours du fait que je pars aux États-Unis \n Mais ne vous inquiètez pas, quand je reviendrai je travaillerai sur une nouvelle commande","Bonnes vacances aux gens qui le sont :wink:")
        msg.channel.send(embed)
    }
    //invite
    ...
    //mute
    if(msg.content.startsWith(prefix + "̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆. ̷̴̛̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆/administrator:mut/zqd")){
        let member = msg.mentions.members.first();
        var mute_msg = msg.content.split(' ').slice(2);
        ...
        try{
          member.addRole(muterole.id)
            msg.channel.send(`${member} a été réduit au s ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.i ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.l ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.e ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.n ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.c ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆.e ̷̴̛̖̖̖̖̖̖̖̖̖̖̖̖͆͆͆͆͆͆͆͆͆͆̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏̏͆͆͆͆͆͆͆͆͆͆. !`)
