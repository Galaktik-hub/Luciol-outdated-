...
bot.on('guildCreate', guild => {
    const embed = new Discord.RichEmbed()
        ...
        .addField(`Grâce à vous, 🔥Luciol🔥 est désormais sur ${bot.guilds.size} serveurs`)
        .setColor("#F03A17")
...
bot.on('guildDelete', guild => {
    const embed = new Discord.RichEmbed()
        ...
        .addField("📝 __ID du serveur__ :", guild.id, true)
        .setColor("#F03A17")
    bot.channels.get('720356857646022716').send(embed);
});
...
bot.on('message' , async msg =>{
    ...
    if(msg.content.startsWith(prefix+ "help")){
        const embed = new Discord.RichEmbed()
            ...
            .addField("🤡 **● Fun:** ","`roll`,`annonce`,`image`,`devin`,`xp`,`avatar`")
            .addField("📡 **● Info:**","`info-bot`,`info-serveur`,`info-user`,`nouveautés`,`ping`")
            .addField("⚒ **● Divers:**","`invite`,`accueil`,`autorole`,`donation`")
    ...
    if(msg.content.startsWith(prefix + "info-bot")){
        ...
        .addField("🕵 __Créateur:__","Galaktik#1281", true)
        ...
        .addField("🕹️ __Status du bot et ping:__",`En ligne | ${new Date().getTime() - msg.createdTimestamp + "ms"}`, true)
        .addField("📋 __ID du bot:__",`630131061657042945`, true)
        .addField("🔗 **● Liens:**","[__**[Invite Bot](https://discordapp.com/oauth2/authorize?client_id=630131061657042945&scope=bot&permissions=8)**__] - [__**[Serveur Support](https://discord.gg/QN8xGCZ)**__]")
        .setThumbnail("https://cdn.discordapp.com/avatars/630131061657042945/08d2d27951687f56e61bd3ce2c138f02.png?size=2048")
    msg.channel.send(embed)
    }
    //info-user
    if(msg.content.startsWith(prefix + "info-user")) {
        ...
        .addField("👀 ● __Tu es:__",`${status[msg.author.presence.status]}`, true)
    ...
    if(!args[0]) return msg.channel.send(embed)
        ...
        .setColor("RANDOM")
        .setFooter("Version 1.0.4")
        .setTitle(`__**Informations concernant ${user_mention.username}:**__`)
        .addField("🤖 ● __Nom d'utilisateur:__",`${user_mention.tag}`, true)
        .addField("🔐 ● __Status:__",`${status[msg.author.presence.status]}`, true)
        .addField("📰 ● __ID:__",`${user_mention.id}`, true)
        .addField("👀 ● __Il est:__",`${user_mention.presence.status}`, true)
        .addField("📁 ● __Date de création du compte:__", moment(user_mention.createdAt).format("LL"), true)
    ...
    if(msg.content.startsWith(prefix + "avatar")) {
        const embed1 = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setTitle("Voici ton image de profil")
        .setImage(msg.author.avatarURL)
    if(!args[0]) return msg.channel.send(embed1)
        const user_mention = msg.mentions.users.first();
        const embed = new Discord.RichEmbed()
        .setColor("RANDOM")
    ...
    if(msg.content.startsWith(prefix + "donation")) {
        const embed = new Discord.RichEmbed()
        .setColor("RANDOM")
        .addField("💸 ● __Pourquoi faire des donations ?__","En faisant une donation, vous m'encouragez à continuer de développer mon bot et de faire de meilleurs commandes de jour en jour. Grâce à vous, mon bot a grandi et continuera de grandir. De plus, en me faisant une donation, je pourrai me payer un meilleur hébergeur que celui que j'ai actuellement :)")
        .addField("🔗 **● Liens:**","[__**[Lien Paypal](https://paypal.me/luciolbot)**__] - [__**[Lien Patreon](https://patreon.com/luciol)**__]")
    msg.channel.send(embed)
    }
    //ping
    ...
    if(msg.content.startsWith(prefix + "nouveautés")){
        ...
        .addField("C'est le grand retour, la commande ??avatar est arrivé avec de nombreuses petits correctifs")
        msg.channel.send(embed)
    }
    //invite
    ...
    if(msg.content === "??Créateur"){
        msg.channel.send("Ce bot a été créé par Galaktik 🌌#6508")
    }
})
...
bot.on('message', async msg => {
	...
	if (command === 'play') {
		...
		if (!serverQueue) return msg.channel.send("Il n'y a rien que je puisse passer !");
