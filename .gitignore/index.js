...
const token = 'NzIxNjkxMDAzMTY1MjEyNzU1.XuYNMQ.nHmb7270vtMkHmgY4YV1HhhcoF0';
const ms = require("ms")
...
const youtube = new YouTube("AIzaSyCMCb2DRLONt7pUCmeeFj9laoQJnqIaqto")
...
bot.on('message' , async msg =>{
    ...
    if(msg.content.startsWith(prefix + "info-bot")){
        ...
        .addField("🕵 __Créateur:__","Galaktik#6508", true)
    ...
    if(!args[0]) return msg.channel.send(embed)
        ...
        .addField("🔐 ● __Status:__",`${user_mention.presence.game}`, true)
